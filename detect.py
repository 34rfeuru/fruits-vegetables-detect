...
from push_stream import get_pipe_process
import torch

sub_process = get_pipe_process()
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if save_img:
                if dataset.mode == "image":
                    ...
                    # type(im0)=numpy.ndarray
                    # type(vid_writer[i])=cv2.VideoWriter
                    vid_writer[i].write(im0)
                    sub_process.stdin.write(im0.tobytes())
